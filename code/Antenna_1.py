...
def mainRadome(path : str):
    ...
    for i in range(N):
            ...
            if types[i] == 'bezier':
                ...
                points1 = geometricalLine(pointM, point1, math.floor(math.sqrt(L*300)), r)
                points2 = geometricalLine(pointM, point2, math.floor(math.sqrt(L*300)), r)
                for p in points1:
